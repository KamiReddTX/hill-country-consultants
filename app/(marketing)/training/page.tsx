      ...
      <section className="bg-white border-b border-line">
        <div className="shell py-16">
          <SectionHeading
            ...
            intro="Half or full day, on site or virtual, with a hands-on build lab where your team produces real deliverables. Content is tailored to your industry before the session. Each class requires a minimum enrollment of 20 participants; the base price covers up to 20, additional attendees are $250 each, and classes book 30–90 days out."
          />
        </div>
      </section>
