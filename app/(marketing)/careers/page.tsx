...
const WHY = [
  ...
  { t: "Remote / Hybrid", d: "Every role is remote-first, with local and regional on-site work when a project calls for it. We serve clients nationwide across time zones." },
