...
const SECTIONS = [
  ...
  { t: "Scope & price in writing", lines: ["Nothing starts without written scope and price. À-la-carte rates are starting points, subject to scope.", "Standalone projects take a 50% deposit; balance on delivery.", "Anything beyond a plan allotment is quoted before it's done."] },
