...
export default async function ClientsPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div><h1 className="font-fraunces text-[32px] font-normal text-forest">All clients</h1><span className="rule-gold mb-4 mt-2" /><p className="text-[14px] prose-muted">Ownership is set by an admin from the Admin tab. No access codes or passwords are shown anywhere in the staff area.</p></div>
