...
export const SERVICE_META: Record<ServiceKey, ServiceMeta> = {
  va: { name: "Virtual Assistant & Admin", desc: "A dedicated assistant, Monday through Friday, on a set block of hours each day — inbox, calendar, CRM, follow-up, file upkeep and a weekly work summary." },
...
export const SERVICE_DETAILS: Record<ServiceKey, ServiceDetail> = {
  va: {
    ...
    pain: "The inbox, the scheduling, the invoicing, the follow-up nobody owns — it all lands on the person least able to drop it. A dedicated assistant handles the recurring administrative work that keeps a business running, on a set number of hours each day, Monday through Friday.",
    ...
    faqs: [
      ...
      { q: "Which days count as business days, and how do the daily and monthly hours relate?", a: "Your assistant works a set block of hours Monday through Friday — 2, 5, or 8 hours per scheduled business day by tier. The monthly figures (approximately 40, 100, or 160 hours) are the sum of that daily block across a typical month — not a guaranteed monthly bank. Hours are scheduled and used day by day; unused hours in a day do not roll over to the next day. Weekends are off, and Saturday coverage is available only by prior arrangement." },
  ...
  pm: {
    ...
    deliverables: [
      ...
      "A written project plan and timeline.",
    ...
    process: [
      ...
      { t: "Plan & board setup", d: "We stand up the task/status board and a written project plan and timeline for your approval." },
    ...
    afterPurchase: "We schedule the strategy session, define scope and 'done,' and stand up your board and a written project plan for approval. Then coordination begins and you track everything from your portal.",
    faqs: [
      ...
      { q: "Do I get a written project plan?", a: "Yes — every project-management engagement includes a documented project plan and timeline you approve before work begins, alongside your live task board. Your tier sets how many projects run concurrently, not whether you get a plan." },
  ...
  submittals: {
    ...
    expect: ["Up to 4, 12, or 24 packages a month by tier, priority turnaround at Enterprise", "Genuine OEM datasheets only, on your letterhead", "Your general contractor or contractor of record reviews and signs", "A final review confirming only this project’s information is present", "Standalone package $350; weekly service $750/wk (any number of packages that week); rush is a $550 surcharge added on top of the package"],
    scope: "Flat fee per unit; revisions beyond the first round are billed separately. We prepare — we do not certify or stamp engineering. Rush turnaround means a compressed schedule faster than the standard production queue, arranged in advance and confirmed in writing; it is a $550 surcharge added on top of the package price, not a replacement for it. Extra submittal packages beyond your plan allotment are billed at a flat $450 per week — that one weekly fee covers any number of additional packages that week (“at any volume”); it is not a per-package charge.",
    ...
    timeline: "Turnaround is quoted per package based on size and complexity. When you're against a deadline, rush adds a $550 surcharge on top of the package price to move it to the front of the queue, and weekly service keeps a steady pipeline moving at $750/week for any number of packages.",
    ...
    addOns: [
      "Rush turnaround — $550 surcharge added on top of the package price.",
      "Weekly service — $750/week covering any number of packages that week.",
      "Extra packages beyond your tier allotment — flat $450/week covering any number of additional packages that week.",
    ...
    faqs: [
      ...
      { q: "How fast is turnaround?", a: "It's quoted per package based on size and complexity. When you're against a deadline, rush adds a $550 surcharge on top of the package price to move it to the front of the queue, and weekly service keeps a steady pipeline moving at $750/week for any number of packages." },
      ...
      { q: "Can you handle high volume every week?", a: "Yes. Weekly service is a flat $750/week covering any number of packages that week. For plan clients, packages beyond your monthly allotment are a flat $450/week — again covering any number of additional packages that week, not a per-package fee." },
    ],
  },
  compliance: {
    ...
    scope: "Legal-wording conflicts are flagged to your attorney and never altered by us. Legal review is your attorney’s role. A “single document” (from $450) is one such deliverable — a capabilities statement, certification or registration document, company profile, one-sheet, or SOP — and includes one revision round. A single document may run multiple pages (for example a multi-page SOP); multi-document packages (say a capabilities statement plus a company profile) are quoted separately.",
    how: HOW,
    forWho: [
  ...
  marketing: {
    ...
    faqs: [
      { q: "What does the $125 marketing graphic include — and what doesn't it?", a: "The $125 covers one defined graphic — a single flyer, social post, ad, or email graphic — produced on your brand: one design concept, two revision rounds, delivered as ready-to-use files (typically PNG and/or PDF, sized for its platform), usually within a few business days. It does not include ongoing marketing work. Social media management, posting and scheduling, content calendars, community management, advertising or campaign management, email-marketing management, and analytics reporting are separate ongoing services — available on a monthly plan, or as a standalone campaign or custom scope. In short: $125 buys the graphic, not the ongoing management around it." },
      { q: "How is copywriting priced?", a: "Two ways, whichever fits the work: per word (from $0.25/word) or per project (from $250). Short pieces and high-volume content often price per word; landing pages, email sequences, and campaigns usually price per project. We confirm the basis in your written scope before anything begins." },
  ...
  brand: {
    ...
    faqs: [
      { q: "Is logo design included?", a: "The Brand Starter Kit includes logo usage rules and variations of your existing logo — not a new logo drawn from scratch. Original logo design is included in the Full Brand System, and is available as an add-on to the Starter Kit." },
      { q: "What's the difference between the $950 Brand Starter Kit and the $3,500+ Full Brand System?", a: "The Starter Kit ($950) is the essentials to look consistent: a core color palette, typography, logo-usage rules and variations of your existing mark, a short brand guide, and a starter set of templates. The Full Brand System ($3,500+) is the complete identity: brand strategy (customer profile, positioning, voice, and tagline direction), original logo design from scratch, the full visual system, collateral (business cards, letterhead, email signature), a comprehensive set of reusable social and document templates, and a full brand guide with governance. The Starter Kit is a subset — it does not include the strategy work, original logo design, or the full template and collateral set that the Full Brand System does." },
      { q: "What exactly is in the Brand Starter Kit?", a: "A core color palette, typography, logo-usage rules and variations of your existing logo, a starter set of templates, and a short written brand guide. Brand strategy, original logo design, and the full collateral and template set are part of the Full Brand System rather than the Starter Kit." },
  ...
  publishing: {
    ...
    deliverables: [
      ...
      "Publishing metadata prepared and an ISBN obtained and assigned to your book before release.",
    ...
    process: [
      ...
      { t: "Metadata & ISBN", d: "We prepare your publishing metadata and help you obtain and assign an ISBN to the book before release." },
    ...
    addOns: [
      ...
      "A Library of Congress Control Number (LCCN) requested for your title through our Preassigned Control Number publisher account.",
  ...
  media: {
    ...
    faqs: [
      { q: "What's included in the $350 podcast episode?", a: "The $350 standalone episode covers one episode up to 90 minutes and includes: audio editing, noise cleanup, intro and outro placement, music placement, and episode cover art (thumbnail), plus one revision round. It does not automatically include video editing, show notes, transcripts, additional social clips, or publishing and distribution to your channels — those are available on a podcast package or higher plan tier, or as add-ons. The Book & Pay description ('edit + cover art') matches this scope." },
  ...
  digital: {
    ...
    timeline: "Typical, non-binding estimates once all your content, approvals, logins, and materials are in hand — a landing page runs about 1–2 weeks; a multi-page website about 3–6 weeks; a PWA MVP about 6–10 weeks; and a custom application is quoted with its own phased timeline. These are estimates, not guaranteed deadlines, and the clock starts after we've received everything we need from you. Pricing: landing page from $650; site or PWA MVP from $2,500 standalone; larger builds from $6,000.",
  ...
  trainingSvc: {
    ...
    how: HOW,
    forWho: [
      "Teams that need to level up on a real skill — fast, hands-on, and tailored to their work.",
      "Owners who want their people to leave with a finished deliverable, not just notes.",
      "Businesses booking a workshop for a launch, an onboarding, or a specific capability gap.",
    ],
    examples: [
      "Operations & Systems", "Winning Work (submittals & compliance)", "Brand, Story & Market Presence",
      "AI to Do the Work", "Business Foundations & Growth", "Grants & Nonprofit Readiness",
      "Regenerative Agriculture & Land", "Food, Nutrition & Wellness",
    ],
    deliverables: [
      "A half- or full-day workshop, on site or live-virtual.",
      "A workbook and resource pack for every participant.",
      "A hands-on build lab that produces real deliverables in the room.",
      "The working deliverables your team builds during the session.",
      "A certificate of completion for each participant.",
      "Post-class materials and a feedback survey.",
    ],
    provide: [
      "Your team and a date 30–90 days out.",
      "The room, or the virtual link.",
      "Context on your tools, industry, and goals so we tailor the content.",
      "A minimum of 20 attendees.",
    ],
    process: [
      { t: "Strategy session", d: "A free 30-minute call to pick the class and tailor it to your team." },
      { t: "Tailor", d: "We adapt the examples, exercises, and build lab to your tools and industry." },
      { t: "Deliver", d: "We teach on site or live-virtual, with a hands-on lab that produces real work." },
      { t: "Hand off", d: "Your team keeps the deliverables, workbook, and resource pack; each participant gets a certificate." },
    ],
    timeline: "Classes book 30–90 days out. Half day is ~4 hours; full day is ~6 hours, and content is tailored before the session.",
    revisions: "Content is tailored to your team before the day; the class is delivered live with the build lab, so there's no post-delivery revision round.",
    software: [
      "The tools relevant to the class — Google Workspace, Microsoft 365, Canva, AI tools, and more.",
      "Live-virtual delivery where your team is remote.",
      "Your team's own accounts wherever the build lab uses them.",
    ],
    notIncluded: [
      "Travel and lodging for on-site training — quoted per booking based on location.",
      "A professional certification — participants receive a certificate of completion, not a licensed credential.",
      "Ongoing implementation after the class (available through our service lines).",
    ],
    addOns: [
      "Additional attendees over 20 — $250 each.",
      "Additional classes beyond your tier's cadence.",
      "Ongoing implementation support through the relevant service line.",
    ],
    ...
    faqs: [
      ...
      { q: "How are travel costs handled?", a: "For on-site training, travel and lodging are quoted per booking based on your location." },
    ],
  },
  systems: {
    ...
    afterPurchase: "We map the process, build and test the automation and dashboards on your tools, document the SOPs and AI guardrails, and train your team — so the repetitive work runs with far less manual handling, with human review preserved where it matters, and the knowledge doesn't live in one person's head.",
    faqs: [
  ...
  events: {
    ...
    provide: [
      ...
      "Vendor decisions and approvals — by default you hold vendor contracts and pay vendors directly; by written agreement we can pay approved costs and bill them back to you at cost.",
    ...
    notIncluded: [
      "Vendor and hard costs themselves (venue, catering, rentals) — “at cost” means the actual amount with no markup. By default you hold the contracts and pay vendors directly; by written agreement we can pay approved costs and bill them back at cost. Either way, these costs are separate from the planning fee.",
    ...
    faqs: [
      ...
      { q: "Who pays the vendors — us or you?", a: "It depends on the event, and we set it in writing. By default you hold the vendor contracts and pay vendors directly, and we source and coordinate. On some events, by agreement, we pay approved costs on your behalf and bill them back at cost — meaning the actual amount with no markup. Either way, vendor and hard costs (venue, catering, rentals) are separate from the planning fee." },
      { q: "What does the $1,500 starting price include?", a: "The $1,500 starting point covers the planning work: the event plan and budget outline, vendor sourcing and coordination, and the run-of-show and timeline. On-site day-of coordination and travel are not automatically included — on-site coordination is a higher-tier plan inclusion or a standalone add-on, and travel and lodging are quoted per event. Vendor and hard costs are separate and billed at cost. The final scope and price are confirmed in writing for your specific event." },
  ...
  ag: {
    ...
    revisions: "Plans and documents are reviewed and adjusted with you within the agreed scope and revision allowance so they fit your land and goals. Substantial changes beyond that scope are quoted separately.",
    software: [
  ...
  grants: {
    ...
    notIncluded: [
      ...
      "Post-award grant management and ongoing funder reporting in a standalone application — available as a separate service, and included only when specifically stated in a plan or custom scope.",
    ...
    faqs: [
      ...
      { q: "What does the $350 grant research report include?", a: "A ranked shortlist of the qualified opportunities we identify during the research period, each with eligibility requirements, funding amount, deadline, the application link, a fit assessment, and our recommended priorities — so you can decide where to focus. Because grant availability changes constantly, we can't promise a fixed number of opportunities; what you receive is the qualified, well-matched opportunities open during the research period." },
      ...
      { q: "Do you manage grants or handle reporting after we win?", a: "A standalone grant application doesn't automatically include post-award grant management or funder reporting — that's a separate service. It's available on its own, and it may be included when your plan or a custom scope specifically states it. The standalone application service focuses on research, preparation, and submission." },
  ...
  notary: {
    ...
    expect: ["A commissioned Texas notary (Texas notary commission #134384502)", "Online notarization by secure remote session, where the law permits", "In-person appointments across Texas", "Available both within a monthly plan and as a standalone service — the state-regulated per-act notary fees below apply either way", "Online notarization $25 each; in-person $10 per notarial act (Texas's regulated maximums), plus a travel fee from $35 for mobile appointments", "Georgia commission in process — in-person Georgia service coming soon"],
    scope: "We notarize signatures and administer oaths and affirmations. We do not provide legal advice, draft or review legal documents, or notarize where a valid ID is missing or a conflict of interest exists. Notary fees follow the maximums set by state law. For in-person appointments, travel starts at $35 — a local starting travel fee; longer distances are quoted before the appointment. “Mobile” notary (included at Enterprise) means we come to your location within our service area.",
    how: HOW,
    forWho: [
