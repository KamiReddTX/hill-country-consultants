...
export const SERVICE_DETAILS: Record<ServiceKey, ServiceDetail> = {
  ...
  submittals: {
    ...
    scope: "Flat fee per unit; revisions beyond the first round are billed separately. We prepare — we do not certify or stamp engineering. Rush is a $550 surcharge added on top of the package price, not a replacement for it. Extra submittal packages beyond your plan allotment are billed at a flat $450 per week — that one weekly fee covers any number of additional packages that week (“at any volume”); it is not a per-package charge.",
