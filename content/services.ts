...
export const SERVICE_DETAILS: Record<ServiceKey, ServiceDetail> = {
  ...
  marketing: {
    ...
    faqs: [
      { q: "What does the $125 marketing graphic include — and what doesn't it?", a: "The $125 price is for one defined graphic product — a single flyer, social post, ad, or email graphic, produced on your brand with your two included revision rounds. It does not include ongoing marketing work. Social media management, social posting and scheduling, content calendars, community management, advertising or campaign management, email-marketing management, and analytics reporting are separate ongoing services — available on a monthly plan, or as a standalone campaign or custom scope. In short: $125 buys the graphic, not the ongoing management around it." },
  ...
  publishing: {
    ...
    faqs: [
      ...
      { q: "What is Redd Ladys Chronicles, and how does the Library of Congress relate to my book?", a: "Redd Ladys Chronicles is our publishing imprint. An ISBN (which identifies your book for sale and distribution) is issued by the ISBN agency — not the Library of Congress — and we help you obtain one you own. A Library of Congress Control Number (LCCN) is a separate catalog record for the title; if you want one, it's an additional step we can walk you through. We don't make a general 'Library of Congress' credibility claim, and we won't imply a benefit your book doesn't actually receive." },
