...
export const PLAN_ROWS: { label: string; f: string; m: string; e: string }[] = [
  ...
  { label: "Events", f: "1 per term", m: "1/quarter + run-of-show", e: "Quarterly + on-site coordination" },
  { label: "Corporate training", f: "1 class per term", m: "1 class/quarter", e: "Quarterly classes + custom track" },
  { label: "Systems & automation", f: "1 workflow per term", m: "Quarterly buildout", e: "Continuous automation retainer" },
  { label: "Agriculture & land", f: "1 deliverable/mo", m: "1 plan/quarter", e: "Full program management" },
