...
export const LEGAL: Record<"policies" | "terms" | "refund-policy" | "privacy", LegalPage> = {
  policies: {
    ...
    sections: [
      ...
      { t: "Plans and terms", lines: ["Plans run a standard 12-month term. A quarterly option is available.", "Monthly fees are split — first half due on the 1st, second half by the 15th — or paid in full.", "A five business-day grace period applies to monthly fees.", "Standalone projects require a 50% deposit before work begins, with the balance due on delivery.", "Renewal happens at the end of the term. Tiers can move up or down at renewal."] },
  ...
  terms: {
    ...
    sections: [
      ...
      { t: "2 · Fees, billing and authorization", lines: ["All prices are in U.S. dollars.", "Plan fees are split — first half due on the 1st, second half by the 15th — or paid in full, and continue for the agreed term. A five business-day grace period applies.", "Standalone projects require a 50% deposit before work begins, with the balance due on delivery.", "By submitting payment on this site you authorize Hill Country Consultants to charge the payment method you provide for the amount shown at booking, and for any amounts you later approve in writing.", "Charges appear on your statement as Hill Country Consultants.", "Accepted methods are credit card, Zelle, or Cash App. We do not accept checks or money orders.", "Work may be paused on accounts past the grace period until the balance is current."] },
      { t: "3 · All sales final", lines: ["All payments are final. We do not issue refunds on plan fees, deposits, project payments, class fees, overage, or rush charges. See the Refund & Cancellation Policy for the full terms.", "Deposits are non-refundable because they reserve capacity and begin work.", "Initiating a chargeback or payment dispute instead of contacting us is a breach of these terms."] },
  ...
  "refund-policy": {
    ...
    sections: [
      { t: "All sales are final", lines: ["We do not issue refunds on plan fees, project payments, deposits, class fees, overage charges, or rush charges.", "This applies whether payment was made by card, Zelle, or Cash App.", "You confirm you have read and accepted this policy at checkout before any payment is taken."] },
